...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/sofiiarudenka/source/streamify/server/prisma/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/sofiiarudenka/source/streamify/server/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:password@localhost:5432/streamify"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"POSTGRES_URI\")\n}\n\nmodel User {\n  id          String   @id @default(uuid())\n  email       String   @unique\n  password    String\n  username    String   @unique\n  displayName String   @map(\"display_name\")\n  avatar      String?\n  bio         String?\n  createdAt   DateTime @default(now()) @map(\"created_at\")\n  updatedAt   DateTime @updatedAt @map(\"updated_at\")\n\n  @@map(\"users\")\n}\n",
  "inlineSchemaHash": "590ed0328f7dde57ad2d0d0d539d57ed71d646bf38880a5f60403d7be80f489d",
  "copyEngine": true
}
